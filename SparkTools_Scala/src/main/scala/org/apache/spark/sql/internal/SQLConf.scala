...
object SQLConf {
   ...
   * only for physical plans (and as a result not in org.apache.spark.sql/catalyst module).
   *
  ...
  val OPTIMIZER_MAX_ITERATIONS = buildConf("spark.org.apache.spark.sql.optimizer.maxIterations")
    .internal()
  ...
  val OPTIMIZER_INSET_CONVERSION_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.optimizer.inSetConversionThreshold")
      .internal()
      .doc("The threshold of set size for InSet conversion.")
      .intConf
      .createWithDefault(10)

  val COMPRESS_CACHED = buildConf("spark.org.apache.spark.sql.inMemoryColumnarStorage.compressed")
    .doc("When set to true Spark SQL will automatically select a compression codec for each " +
      "column based on statistics of the data.")
    .booleanConf
    .createWithDefault(true)

  val COLUMN_BATCH_SIZE = buildConf("spark.org.apache.spark.sql.inMemoryColumnarStorage.batchSize")
  ...
  val IN_MEMORY_PARTITION_PRUNING =
    buildConf("spark.org.apache.spark.sql.inMemoryColumnarStorage.partitionPruning")
      .internal()
  ...
  val CACHE_VECTORIZED_READER_ENABLED =
    buildConf("spark.org.apache.spark.sql.inMemoryColumnarStorage.enableVectorizedReader")
      .doc("Enables vectorized reader for columnar caching.")
      .booleanConf
      .createWithDefault(true)

  val COLUMN_VECTOR_OFFHEAP_ENABLED =
    buildConf("spark.org.apache.spark.sql.columnVector.offheap.enabled")
      .internal()
      .doc("When true, use OffHeapColumnVector in ColumnarBatch.")
      .booleanConf
      .createWithDefault(false)

  val PREFER_SORTMERGEJOIN = buildConf("spark.org.apache.spark.sql.join.preferSortMergeJoin")
    .internal()
    .doc("When true, prefer sort merge join over shuffle hash join.")
    .booleanConf
    .createWithDefault(true)

  val RADIX_SORT_ENABLED = buildConf("spark.org.apache.spark.sql.sort.enableRadixSort")
    .internal()
  ...
  val AUTO_BROADCASTJOIN_THRESHOLD = buildConf("spark.org.apache.spark.sql.autoBroadcastJoinThreshold")
  ...
  val LIMIT_SCALE_UP_FACTOR = buildConf("spark.org.apache.spark.sql.limit.scaleUpFactor")
    .internal()
  ...
  val ADVANCED_PARTITION_PREDICATE_PUSHDOWN =
    buildConf("spark.org.apache.spark.sql.hive.advancedPartitionPredicatePushdown.enabled")
      .internal()
  ...
  val ENABLE_FALL_BACK_TO_HDFS_FOR_STATS =
    buildConf("spark.org.apache.spark.sql.statistics.fallBackToHdfs")
  ...
  val DEFAULT_SIZE_IN_BYTES = buildConf("spark.org.apache.spark.sql.defaultSizeInBytes")
    .internal()
    .doc("The default table size used in query planning. By default, it is set to Long.MaxValue " +
      "which is larger than `spark.org.apache.spark.sql.autoBroadcastJoinThreshold` to be more conservative. " +
      "That is to say by default the optimizer will not choose to broadcast a table unless it " +
      "knows for sure its size is small enough.")
    .longConf
    .createWithDefault(Long.MaxValue)

  val SHUFFLE_PARTITIONS = buildConf("spark.org.apache.spark.sql.shuffle.partitions")
    .doc("The default number of partitions to use when shuffling data for joins or aggregations.")
    .intConf
    .createWithDefault(200)

  val SHUFFLE_TARGET_POSTSHUFFLE_INPUT_SIZE =
    buildConf("spark.org.apache.spark.sql.adaptive.shuffle.targetPostShuffleInputSize")
      .doc("The target post-shuffle input size in bytes of a task.")
      .bytesConf(ByteUnit.BYTE)
      .createWithDefault(64 * 1024 * 1024)

  val ADAPTIVE_EXECUTION_ENABLED = buildConf("spark.org.apache.spark.sql.adaptive.enabled")
    .doc("When true, enable adaptive query execution.")
    .booleanConf
    .createWithDefault(false)

  val SHUFFLE_MIN_NUM_POSTSHUFFLE_PARTITIONS =
    buildConf("spark.org.apache.spark.sql.adaptive.minNumPostShufflePartitions")
      .internal()
  ...
  val SUBEXPRESSION_ELIMINATION_ENABLED =
    buildConf("spark.org.apache.spark.sql.subexpressionElimination.enabled")
      .internal()
      .doc("When true, common subexpressions will be eliminated.")
      .booleanConf
      .createWithDefault(true)

  val CASE_SENSITIVE = buildConf("spark.org.apache.spark.sql.caseSensitive")
    .internal()
  ...
  val CONSTRAINT_PROPAGATION_ENABLED = buildConf("spark.org.apache.spark.sql.constraintPropagation.enabled")
    .internal()
  ...
  val ESCAPED_STRING_LITERALS = buildConf("spark.org.apache.spark.sql.parser.escapedStringLiterals")
    .internal()
  ...
  val FILE_COMRESSION_FACTOR = buildConf("spark.org.apache.spark.sql.sources.fileCompressionFactor")
    .internal()
  ...
  val PARQUET_SCHEMA_MERGING_ENABLED = buildConf("spark.org.apache.spark.sql.parquet.mergeSchema")
  ...
  val PARQUET_SCHEMA_RESPECT_SUMMARIES = buildConf("spark.org.apache.spark.sql.parquet.respectSummaryFiles")
  ...
  val PARQUET_BINARY_AS_STRING = buildConf("spark.org.apache.spark.sql.parquet.binaryAsString")
  ...
  val PARQUET_INT96_AS_TIMESTAMP = buildConf("spark.org.apache.spark.sql.parquet.int96AsTimestamp")
  ...
  val PARQUET_INT96_TIMESTAMP_CONVERSION = buildConf("spark.org.apache.spark.sql.parquet.int96TimestampConversion")
  ...
  val PARQUET_OUTPUT_TIMESTAMP_TYPE = buildConf("spark.org.apache.spark.sql.parquet.outputTimestampType")
  ...
  val PARQUET_INT64_AS_TIMESTAMP_MILLIS = buildConf("spark.org.apache.spark.sql.parquet.int64AsTimestampMillis")
  ...
  val PARQUET_COMPRESSION = buildConf("spark.org.apache.spark.sql.parquet.compression.codec")
    .doc("Sets the compression codec used when writing Parquet files. If either `compression` or " +
      "`parquet.compression` is specified in the table-specific options/properties, the " +
      "precedence would be `compression`, `parquet.compression`, " +
      "`spark.org.apache.spark.sql.parquet.compression.codec`. Acceptable values include: none, uncompressed, " +
      "snappy, gzip, lzo.")
    .stringConf
  ...
  val PARQUET_FILTER_PUSHDOWN_ENABLED = buildConf("spark.org.apache.spark.sql.parquet.filterPushdown")
    .doc("Enables Parquet filter push-down optimization when set to true.")
    .booleanConf
    .createWithDefault(true)

  val PARQUET_WRITE_LEGACY_FORMAT = buildConf("spark.org.apache.spark.sql.parquet.writeLegacyFormat")
  ...
  val PARQUET_RECORD_FILTER_ENABLED = buildConf("spark.org.apache.spark.sql.parquet.recordLevelFilter.enabled")
    .doc("If true, enables Parquet's native record-level filtering using the pushed down " +
      "filters. This configuration only has an effect when 'spark.org.apache.spark.sql.parquet.filterPushdown' " +
      "is enabled.")
    .booleanConf
    .createWithDefault(false)

  val PARQUET_OUTPUT_COMMITTER_CLASS = buildConf("spark.org.apache.spark.sql.parquet.output.committer.class")
  ...
  val PARQUET_VECTORIZED_READER_ENABLED =
    buildConf("spark.org.apache.spark.sql.parquet.enableVectorizedReader")
      .doc("Enables vectorized parquet decoding.")
      .booleanConf
      .createWithDefault(true)

  val ORC_COMPRESSION = buildConf("spark.org.apache.spark.sql.orc.compression.codec")
    .doc("Sets the compression codec used when writing ORC files. If either `compression` or " +
      "`orc.compress` is specified in the table-specific options/properties, the precedence " +
      "would be `compression`, `orc.compress`, `spark.org.apache.spark.sql.orc.compression.codec`." +
  ...
  val ORC_IMPLEMENTATION = buildConf("spark.org.apache.spark.sql.orc.impl")
  ...
  val ORC_VECTORIZED_READER_ENABLED = buildConf("spark.org.apache.spark.sql.orc.enableVectorizedReader")
    .doc("Enables vectorized orc decoding.")
    .booleanConf
    .createWithDefault(true)

  val ORC_COPY_BATCH_TO_SPARK = buildConf("spark.org.apache.spark.sql.orc.copyBatchToSpark")
  ...
  val ORC_FILTER_PUSHDOWN_ENABLED = buildConf("spark.org.apache.spark.sql.orc.filterPushdown")
    .doc("When true, enable filter pushdown for ORC files.")
    .booleanConf
    .createWithDefault(false)

  val HIVE_VERIFY_PARTITION_PATH = buildConf("spark.org.apache.spark.sql.hive.verifyPartitionPath")
  ...
  val HIVE_METASTORE_PARTITION_PRUNING =
    buildConf("spark.org.apache.spark.sql.hive.metastorePartitionPruning")
  ...
  val HIVE_MANAGE_FILESOURCE_PARTITIONS =
    buildConf("spark.org.apache.spark.sql.hive.manageFilesourcePartitions")
  ...
  val HIVE_FILESOURCE_PARTITION_FILE_CACHE_SIZE =
    buildConf("spark.org.apache.spark.sql.hive.filesourcePartitionFileCacheSize")
  ...
  val HIVE_CASE_SENSITIVE_INFERENCE = buildConf("spark.org.apache.spark.sql.hive.caseSensitiveInferenceMode")
  ...
  val OPTIMIZER_METADATA_ONLY = buildConf("spark.org.apache.spark.sql.optimizer.metadataOnly")
  ...
  val COLUMN_NAME_OF_CORRUPT_RECORD = buildConf("spark.org.apache.spark.sql.columnNameOfCorruptRecord")
    .doc("The name of internal column for storing raw/un-parsed JSON and CSV records that fail " +
      "to parse.")
    .stringConf
    .createWithDefault("_corrupt_record")

  val FROM_JSON_FORCE_NULLABLE_SCHEMA = buildConf("spark.org.apache.spark.sql.fromJsonForceNullableSchema")
    .internal()
  ...
  val BROADCAST_TIMEOUT = buildConf("spark.org.apache.spark.sql.broadcastTimeout")
    .doc("Timeout in seconds for the broadcast wait time in broadcast joins.")
    .timeConf(TimeUnit.SECONDS)
    .createWithDefault(5 * 60)

  // This is only used for the thriftserver
  val THRIFTSERVER_POOL = buildConf("spark.org.apache.spark.sql.thriftserver.scheduler.pool")
    .doc("Set a Fair Scheduler pool for a JDBC client session.")
    .stringConf
    .createOptional

  val THRIFTSERVER_INCREMENTAL_COLLECT =
    buildConf("spark.org.apache.spark.sql.thriftServer.incrementalCollect")
      .internal()
  ...
  val THRIFTSERVER_UI_STATEMENT_LIMIT =
    buildConf("spark.org.apache.spark.sql.thriftserver.ui.retainedStatements")
      .doc("The number of SQL statements kept in the JDBC/ODBC web UI history.")
      .intConf
      .createWithDefault(200)

  val THRIFTSERVER_UI_SESSION_LIMIT = buildConf("spark.org.apache.spark.sql.thriftserver.ui.retainedSessions")
    .doc("The number of SQL client sessions kept in the JDBC/ODBC web UI history.")
    .intConf
    .createWithDefault(200)

  // This is used to set the default data source
  val DEFAULT_DATA_SOURCE_NAME = buildConf("spark.org.apache.spark.sql.sources.default")
    .doc("The default data source to use in input/output.")
    .stringConf
    .createWithDefault("parquet")

  val CONVERT_CTAS = buildConf("spark.org.apache.spark.sql.hive.convertCTAS")
    .internal()
    .doc("When true, a table created by a Hive CTAS statement (no USING clause) " +
      ...
      "using the data source set by spark.org.apache.spark.sql.sources.default.")
    .booleanConf
    .createWithDefault(false)

  val GATHER_FASTSTAT = buildConf("spark.org.apache.spark.sql.hive.gatherFastStats")
      .internal()
  ...
  val PARTITION_COLUMN_TYPE_INFERENCE =
    buildConf("spark.org.apache.spark.sql.sources.partitionColumnTypeInference.enabled")
      .doc("When true, automatically infer the data types for partitioned columns.")
      .booleanConf
      .createWithDefault(true)

  val BUCKETING_ENABLED = buildConf("spark.org.apache.spark.sql.sources.bucketing.enabled")
    .doc("When false, we will treat bucketed table as normal table")
    .booleanConf
    .createWithDefault(true)

  val CROSS_JOINS_ENABLED = buildConf("spark.org.apache.spark.sql.crossJoin.enabled")
    .doc("When false, we will throw an error if a query contains a cartesian product without " +
        "explicit CROSS JOIN syntax.")
    .booleanConf
    .createWithDefault(false)

  val ORDER_BY_ORDINAL = buildConf("spark.org.apache.spark.sql.orderByOrdinal")
    .doc("When true, the ordinal numbers are treated as the position in the select list. " +
         "When false, the ordinal numbers in order/sort by clause are ignored.")
    .booleanConf
    .createWithDefault(true)

  val GROUP_BY_ORDINAL = buildConf("spark.org.apache.spark.sql.groupByOrdinal")
    .doc("When true, the ordinal numbers in group by clauses are treated as the position " +
      "in the select list. When false, the ordinal numbers are ignored.")
    .booleanConf
    .createWithDefault(true)

  val GROUP_BY_ALIASES = buildConf("spark.org.apache.spark.sql.groupByAliases")
  ...
  val OUTPUT_COMMITTER_CLASS = buildConf("spark.org.apache.spark.sql.sources.outputCommitterClass")
    .internal()
    .stringConf
    .createOptional

  val FILE_COMMIT_PROTOCOL_CLASS =
    buildConf("spark.org.apache.spark.sql.sources.commitProtocolClass")
      .internal()
      .stringConf
      .createWithDefault(
        "org.apache.spark.org.apache.spark.sql.execution.datasources.SQLHadoopMapReduceCommitProtocol")

  val PARALLEL_PARTITION_DISCOVERY_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.sources.parallelPartitionDiscovery.threshold")
  ...
  val PARALLEL_PARTITION_DISCOVERY_PARALLELISM =
    buildConf("spark.org.apache.spark.sql.sources.parallelPartitionDiscovery.parallelism")
  ...
  val DATAFRAME_SELF_JOIN_AUTO_RESOLVE_AMBIGUITY =
    buildConf("spark.org.apache.spark.sql.selfJoinAutoResolveAmbiguity")
      .internal()
      .booleanConf
      .createWithDefault(true)

  // Whether to retain group by columns or not in GroupedData.agg.
  val DATAFRAME_RETAIN_GROUP_COLUMNS = buildConf("spark.org.apache.spark.sql.retainGroupColumns")
    .internal()
    .booleanConf
    .createWithDefault(true)

  val DATAFRAME_PIVOT_MAX_VALUES = buildConf("spark.org.apache.spark.sql.pivotMaxValues")
    .doc("When doing a pivot without specifying values for the pivot column this is the maximum " +
      "number of (distinct) values that will be collected without error.")
    .intConf
    .createWithDefault(10000)

  val RUN_SQL_ON_FILES = buildConf("spark.org.apache.spark.sql.runSQLOnFiles")
    .internal()
    .doc("When true, we could use `datasource`.`path` as table in SQL query.")
    .booleanConf
    .createWithDefault(true)

  val WHOLESTAGE_CODEGEN_ENABLED = buildConf("spark.org.apache.spark.sql.codegen.wholeStage")
    .internal()
  ...
  val WHOLESTAGE_CODEGEN_USE_ID_IN_CLASS_NAME =
    buildConf("spark.org.apache.spark.sql.codegen.useIdInClassName")
    .internal()
  ...
  val WHOLESTAGE_MAX_NUM_FIELDS = buildConf("spark.org.apache.spark.sql.codegen.maxFields")
    .internal()
  ...
  val CODEGEN_FALLBACK = buildConf("spark.org.apache.spark.sql.codegen.fallback")
    .internal()
  ...
  val CODEGEN_LOGGING_MAX_LINES = buildConf("spark.org.apache.spark.sql.codegen.logging.maxLines")
    .internal()
  ...
  val WHOLESTAGE_HUGE_METHOD_LIMIT = buildConf("spark.org.apache.spark.sql.codegen.hugeMethodLimit")
    .internal()
  ...
  val WHOLESTAGE_SPLIT_CONSUME_FUNC_BY_OPERATOR =
    buildConf("spark.org.apache.spark.sql.codegen.splitConsumeFuncByOperator")
      .internal()
  ...
  val FILES_MAX_PARTITION_BYTES = buildConf("spark.org.apache.spark.sql.files.maxPartitionBytes")
    .doc("The maximum number of bytes to pack into a single partition when reading files.")
    .longConf
    .createWithDefault(128 * 1024 * 1024) // parquet.block.size

  val FILES_OPEN_COST_IN_BYTES = buildConf("spark.org.apache.spark.sql.files.openCostInBytes")
    .internal()
  ...
  val IGNORE_CORRUPT_FILES = buildConf("spark.org.apache.spark.sql.files.ignoreCorruptFiles")
    .doc("Whether to ignore corrupt files. If true, the Spark jobs will continue to run when " +
      "encountering corrupted files and the contents that have been read will still be returned.")
    .booleanConf
    .createWithDefault(false)

  val IGNORE_MISSING_FILES = buildConf("spark.org.apache.spark.sql.files.ignoreMissingFiles")
    .doc("Whether to ignore missing files. If true, the Spark jobs will continue to run when " +
      "encountering missing files and the contents that have been read will still be returned.")
    .booleanConf
    .createWithDefault(false)

  val MAX_RECORDS_PER_FILE = buildConf("spark.org.apache.spark.sql.files.maxRecordsPerFile")
    .doc("Maximum number of records to write out to a single file. " +
      "If this value is zero or negative, there is no limit.")
    .longConf
    .createWithDefault(0)

  val EXCHANGE_REUSE_ENABLED = buildConf("spark.org.apache.spark.sql.exchange.reuse")
    .internal()
  ...
  val STATE_STORE_PROVIDER_CLASS =
    buildConf("spark.org.apache.spark.sql.streaming.stateStore.providerClass")
      .internal()
      .doc(
      ...
      .stringConf
      .createWithDefault(
        "org.apache.spark.org.apache.spark.sql.execution.streaming.state.HDFSBackedStateStoreProvider")

  val STATE_STORE_MIN_DELTAS_FOR_SNAPSHOT =
    buildConf("spark.org.apache.spark.sql.streaming.stateStore.minDeltasForSnapshot")
      .internal()
  ...
  val CHECKPOINT_LOCATION = buildConf("spark.org.apache.spark.sql.streaming.checkpointLocation")
    .doc("The default location for storing checkpoint data for streaming queries.")
    .stringConf
    .createOptional

  val MIN_BATCHES_TO_RETAIN = buildConf("spark.org.apache.spark.sql.streaming.minBatchesToRetain")
    .internal()
  ...
  val UNSUPPORTED_OPERATION_CHECK_ENABLED =
    buildConf("spark.org.apache.spark.sql.streaming.unsupportedOperationCheck")
      .internal()
  ...
  val VARIABLE_SUBSTITUTE_ENABLED =
    buildConf("spark.org.apache.spark.sql.variable.substitute")
      .doc("This enables substitution using syntax like ${var} ${system:var} and ${env:var}.")
      .booleanConf
      .createWithDefault(true)

  val VARIABLE_SUBSTITUTE_DEPTH =
    buildConf("spark.org.apache.spark.sql.variable.substitute.depth")
      .internal()
  ...
  val ENABLE_TWOLEVEL_AGG_MAP =
    buildConf("spark.org.apache.spark.sql.codegen.aggregate.map.twolevel.enabled")
      .internal()
  ...
  val MAX_NESTED_VIEW_DEPTH =
    buildConf("spark.org.apache.spark.sql.view.maxNestedViewDepth")
      .internal()
  ...
  val STREAMING_FILE_COMMIT_PROTOCOL_CLASS =
    buildConf("spark.org.apache.spark.sql.streaming.commitProtocolClass")
      .internal()
      .stringConf
      .createWithDefault("org.apache.spark.org.apache.spark.sql.execution.streaming.ManifestFileCommitProtocol")

  val OBJECT_AGG_SORT_BASED_FALLBACK_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.objectHashAggregate.sortBased.fallbackThreshold")
      .internal()
  ...
  val USE_OBJECT_HASH_AGG = buildConf("spark.org.apache.spark.sql.execution.useObjectHashAggregateExec")
    .internal()
    .doc("Decides if we use ObjectHashAggregateExec")
    .booleanConf
    .createWithDefault(true)

  val FILE_SINK_LOG_DELETION = buildConf("spark.org.apache.spark.sql.streaming.fileSink.log.deletion")
    .internal()
  ...
  val FILE_SINK_LOG_COMPACT_INTERVAL =
    buildConf("spark.org.apache.spark.sql.streaming.fileSink.log.compactInterval")
      .internal()
  ...
  val FILE_SINK_LOG_CLEANUP_DELAY =
    buildConf("spark.org.apache.spark.sql.streaming.fileSink.log.cleanupDelay")
      .internal()
      .doc("How long that a file is guaranteed to be visible for all readers.")
      .timeConf(TimeUnit.MILLISECONDS)
      .createWithDefault(TimeUnit.MINUTES.toMillis(10)) // 10 minutes

  val FILE_SOURCE_LOG_DELETION = buildConf("spark.org.apache.spark.sql.streaming.fileSource.log.deletion")
    .internal()
  ...
  val FILE_SOURCE_LOG_COMPACT_INTERVAL =
    buildConf("spark.org.apache.spark.sql.streaming.fileSource.log.compactInterval")
      .internal()
      .doc("Number of log files after which all the previous files " +
        "are compacted into the next log file.")
      .intConf
  ...
  val FILE_SOURCE_LOG_CLEANUP_DELAY =
    buildConf("spark.org.apache.spark.sql.streaming.fileSource.log.cleanupDelay")
      .internal()
  ...
  val STREAMING_SCHEMA_INFERENCE =
    buildConf("spark.org.apache.spark.sql.streaming.schemaInference")
      .internal()
  ...
  val STREAMING_POLLING_DELAY =
    buildConf("spark.org.apache.spark.sql.streaming.pollingDelay")
      .internal()
  ...
  val STREAMING_NO_DATA_PROGRESS_EVENT_INTERVAL =
    buildConf("spark.org.apache.spark.sql.streaming.noDataProgressEventInterval")
      .internal()
  ...
  val STREAMING_METRICS_ENABLED =
    buildConf("spark.org.apache.spark.sql.streaming.metricsEnabled")
      .doc("Whether Dropwizard/Codahale metrics will be reported for active streaming queries.")
      .booleanConf
      .createWithDefault(false)

  val STREAMING_PROGRESS_RETENTION =
    buildConf("spark.org.apache.spark.sql.streaming.numRecentProgressUpdates")
      .doc("The number of progress updates to retain for a streaming query")
      .intConf
      .createWithDefault(100)

  val NDV_MAX_ERROR =
    buildConf("spark.org.apache.spark.sql.statistics.ndv.maxError")
      .internal()
  ...
  val HISTOGRAM_ENABLED =
    buildConf("spark.org.apache.spark.sql.statistics.histogram.enabled")
  ...
  val HISTOGRAM_NUM_BINS =
    buildConf("spark.org.apache.spark.sql.statistics.histogram.numBins")
      .internal()
  ...
  val PERCENTILE_ACCURACY =
    buildConf("spark.org.apache.spark.sql.statistics.percentile.accuracy")
      .internal()
  ...
  val AUTO_SIZE_UPDATE_ENABLED =
    buildConf("spark.org.apache.spark.sql.statistics.size.autoUpdate.enabled")
  ...
  val CBO_ENABLED =
    buildConf("spark.org.apache.spark.sql.cbo.enabled")
      .doc("Enables CBO for estimation of plan statistics when set true.")
      .booleanConf
      .createWithDefault(false)

  val JOIN_REORDER_ENABLED =
    buildConf("spark.org.apache.spark.sql.cbo.joinReorder.enabled")
      .doc("Enables join reorder in CBO.")
      .booleanConf
      .createWithDefault(false)

  val JOIN_REORDER_DP_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.cbo.joinReorder.dp.threshold")
  ...
  val JOIN_REORDER_CARD_WEIGHT =
    buildConf("spark.org.apache.spark.sql.cbo.joinReorder.card.weight")
      .internal()
  ...
  val JOIN_REORDER_DP_STAR_FILTER =
    buildConf("spark.org.apache.spark.sql.cbo.joinReorder.dp.star.filter")
      .doc("Applies star-join filter heuristics to cost based join enumeration.")
      .booleanConf
      .createWithDefault(false)

  val STARSCHEMA_DETECTION = buildConf("spark.org.apache.spark.sql.cbo.starSchemaDetection")
    .doc("When true, it enables join reordering based on star schema detection. ")
    .booleanConf
    .createWithDefault(false)

  val STARSCHEMA_FACT_TABLE_RATIO = buildConf("spark.org.apache.spark.sql.cbo.starJoinFTRatio")
    .internal()
  ...
  val SESSION_LOCAL_TIMEZONE =
    buildConf("spark.org.apache.spark.sql.session.timeZone")
      .doc("""The ID of session local timezone, e.g. "GMT", "America/Los_Angeles", etc.""")
      .stringConf
      .createWithDefaultFunction(() => TimeZone.getDefault.getID)

  val WINDOW_EXEC_BUFFER_IN_MEMORY_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.windowExec.buffer.in.memory.threshold")
      .internal()
  ...
  val WINDOW_EXEC_BUFFER_SPILL_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.windowExec.buffer.spill.threshold")
      .internal()
  ...
  val SORT_MERGE_JOIN_EXEC_BUFFER_IN_MEMORY_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.sortMergeJoinExec.buffer.in.memory.threshold")
      .internal()
  ...
  val SORT_MERGE_JOIN_EXEC_BUFFER_SPILL_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.sortMergeJoinExec.buffer.spill.threshold")
      .internal()
  ...
  val CARTESIAN_PRODUCT_EXEC_BUFFER_IN_MEMORY_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.cartesianProductExec.buffer.in.memory.threshold")
      .internal()
  ...
  val CARTESIAN_PRODUCT_EXEC_BUFFER_SPILL_THRESHOLD =
    buildConf("spark.org.apache.spark.sql.cartesianProductExec.buffer.spill.threshold")
      .internal()
      .doc("Threshold for number of rows to be spilled by cartesian product operator")
      .intConf
      .createWithDefault(SHUFFLE_SPILL_NUM_ELEMENTS_FORCE_SPILL_THRESHOLD.defaultValue.get)

  val SUPPORT_QUOTED_REGEX_COLUMN_NAME = buildConf("spark.org.apache.spark.sql.parser.quotedRegexColumnNames")
  ...
  val RANGE_EXCHANGE_SAMPLE_SIZE_PER_PARTITION =
    buildConf("spark.org.apache.spark.sql.execution.rangeExchange.sampleSizePerPartition")
      .internal()
  ...
  val ARROW_EXECUTION_ENABLE =
    buildConf("spark.org.apache.spark.sql.execution.arrow.enabled")
      .doc("When true, make use of Apache Arrow for columnar data transfers. Currently available " +
        "for use with pyspark.org.apache.spark.sql.DataFrame.toPandas, and " +
        "pyspark.org.apache.spark.sql.SparkSession.createDataFrame when its input is a Pandas DataFrame. " +
  ...
  val ARROW_EXECUTION_MAX_RECORDS_PER_BATCH =
    buildConf("spark.org.apache.spark.sql.execution.arrow.maxRecordsPerBatch")
  ...
  val PANDAS_RESPECT_SESSION_LOCAL_TIMEZONE =
    buildConf("spark.org.apache.spark.sql.execution.pandas.respectSessionTimeZone")
      .internal()
  ...
  val REPLACE_EXCEPT_WITH_FILTER = buildConf("spark.org.apache.spark.sql.optimizer.replaceExceptWithFilter")
    .internal()
  ...
  val DECIMAL_OPERATIONS_ALLOW_PREC_LOSS =
    buildConf("spark.org.apache.spark.sql.decimalOperations.allowPrecisionLoss")
      .internal()
  ...
  val SQL_OPTIONS_REDACTION_PATTERN =
    buildConf("spark.org.apache.spark.sql.redaction.options.regex")
  ...
  val SQL_STRING_REDACTION_PATTERN =
    buildConf("spark.org.apache.spark.sql.redaction.string.regex")
  ...
  val CONCAT_BINARY_AS_STRING = buildConf("spark.org.apache.spark.sql.function.concatBinaryAsString")
    .doc("When this option is set to false and all inputs are binary, `functions.concat` returns " +
      "an output as binary. Otherwise, it returns as a string. ")
    .booleanConf
    .createWithDefault(false)

  val ELT_OUTPUT_AS_STRING = buildConf("spark.org.apache.spark.sql.function.eltOutputAsString")
  ...
  val CONTINUOUS_STREAMING_EXECUTOR_QUEUE_SIZE =
    buildConf("spark.org.apache.spark.sql.streaming.continuous.executorQueueSize")
    .internal()
  ...
  val CONTINUOUS_STREAMING_EXECUTOR_POLL_INTERVAL_MS =
    buildConf("spark.org.apache.spark.sql.streaming.continuous.executorPollIntervalMs")
      .internal()
  ...
  val DISABLED_V2_STREAMING_WRITERS = buildConf("spark.org.apache.spark.sql.streaming.disabledV2Writers")
    .internal()
  ...
  val PARTITION_OVERWRITE_MODE =
    buildConf("spark.org.apache.spark.sql.sources.partitionOverwriteMode")
  ...
  val SORT_BEFORE_REPARTITION =
    buildConf("spark.org.apache.spark.sql.execution.sortBeforeRepartition")
      .internal()
 ...
 * into Spark SQL's query functions (i.e. org.apache.spark.sql()). Otherwise, users of this class can
