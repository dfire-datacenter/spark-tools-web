...
class CodegenContext {
  ...
  def genComp(dataType: DataType, c1: String, c2: String): String = dataType match {
    ...
    case BinaryType => s"org.apache.spark.org.apache.spark.sql.catalyst.util.TypeUtils.compareBinary($c1, $c2)"
    case NullType => "0"
  ...
  def registerComment(text: => String): String = {
    ...
    if (SparkEnv.get != null && SparkEnv.get.conf.getBoolean("spark.org.apache.spark.sql.codegen.comments", false)) {
...
object CodeGenerator extends Logging {
  ...
  private[this] def doCompile(code: CodeAndComment): (GeneratedClass, Int) = {
    ...
    evaluator.setClassName("org.apache.spark.org.apache.spark.sql.catalyst.expressions.GeneratedClass")
