...
class SessionCatalog(
  ...
  protected def makeFunctionExpression(
    ...
    val clsForUDAF =
      Utils.classForName("org.apache.spark.org.apache.spark.sql.expressions.UserDefinedAggregateFunction")
    if (clsForUDAF.isAssignableFrom(clazz)) {
      val cls = Utils.classForName("org.apache.spark.org.apache.spark.sql.execution.aggregate.ScalaUDAF")
