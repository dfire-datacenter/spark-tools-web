...
object Row {
   ...
   * {{{
   * import org.apache.spark.org.apache.spark.sql._
   *
   * val pairs = org.apache.spark.sql("SELECT key, value FROM src").rdd.map {
...
trait Row extends Serializable {
   ...
   *
   *   DateType -> java.org.apache.spark.sql.Date
   *   TimestampType -> java.org.apache.spark.sql.Timestamp
   *
   *   BinaryType -> byte array
   *   ArrayType -> scala.collection.Seq (use getList for java.util.List)
   *   MapType -> scala.collection.Map (use getJavaMap for java.util.Map)
   *   StructType -> org.apache.spark.org.apache.spark.sql.Row
   * }}}
   */
  ...
  /**
   * Returns the value at position i of date type as java.org.apache.spark.sql.Date.
   *
   * @throws ClassCastException when data type does not match.
   */
  ...
  /**
   * Returns the value at position i of date type as java.org.apache.spark.sql.Timestamp.
   *
   * @throws ClassCastException when data type does not match.
   */
