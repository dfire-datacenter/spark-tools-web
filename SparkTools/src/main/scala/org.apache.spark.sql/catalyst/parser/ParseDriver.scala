...
import antlr4.org.apache.spark.sql.catalyst.parser.{SqlBaseBaseListener, SqlBaseLexer, SqlBaseParser}
...
/**
  ...
  */
trait AbstractSqlParser extends ParserInterface with Logging {
