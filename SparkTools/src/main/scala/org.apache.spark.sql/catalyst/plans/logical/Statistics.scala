...
case class ColumnStat(
   ...
   * example, for DateType we store java.org.apache.spark.sql.Date, and for TimestampType we store
   * java.org.apache.spark.sql.Timestamp. The deserialization side is defined in [[ColumnStat.fromMap]].
   *
