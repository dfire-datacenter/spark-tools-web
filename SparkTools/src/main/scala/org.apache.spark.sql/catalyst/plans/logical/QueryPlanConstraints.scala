...
import org.apache.spark.sql.catalyst.expressions.{Attribute, EqualTo, Expression, ExpressionSet, IsNotNull, NullIntolerant}
...
trait QueryPlanConstraints {
  ...
  /**
    ...
    * [[outputSet]].
    *
    * See [[org.apache.spark.sql.catalyst.expressions.Canonicalize]] for more details.
    */
