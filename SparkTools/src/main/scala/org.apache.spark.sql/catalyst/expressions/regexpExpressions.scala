  ...
  arguments = """
    Arguments:
      ...
      * pattern - a string expression. The pattern is a string which is matched literally, with
          ...
          When SQL config 'spark.org.apache.spark.sql.parser.escapedStringLiterals' is enabled, it fallbacks
  ...
  arguments = """
    Arguments:
      ...
      * regexp - a string expression. The pattern string should be a Java regular expression.
          ...
          There is a SQL config 'spark.org.apache.spark.sql.parser.escapedStringLiterals' that can be used to
          fallback to the Spark 1.6 behavior regarding string literal parsing. For example,
          if the config is enabled, the `regexp` that can match "\abc" is "^\abc$".
  """,
  examples = """
    Examples:
      When spark.org.apache.spark.sql.parser.escapedStringLiterals is disabled (default).
      > SELECT '%SystemDrive%\Users\John' _FUNC_ '%SystemDrive%\\Users.*'
      true

      When spark.org.apache.spark.sql.parser.escapedStringLiterals is enabled.
      > SELECT '%SystemDrive%\Users\John' _FUNC_ '%SystemDrive%\Users.*'
      true
  """,
  note = """
