...
/**
  * Provides a logical query plan [[org.apache.spark.sql.catalyst.analysis.Analyzer]] and supporting classes for performing analysis.
  * Analysis consists of translating [[org.apache.spark.sql.catalyst.analysis.UnresolvedAttribute]]s and [[org.apache.spark.sql.catalyst.analysis.UnresolvedRelation]]s
