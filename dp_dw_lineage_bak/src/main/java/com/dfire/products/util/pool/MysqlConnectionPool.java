package com.dfire.products.util.pool;
...
/**
 * @Description : 连接池entity
 * @Author ： HeGuoZi
 * @Date ： 2:28 PM 2018/12/13
 * @Modified :
 */
public class MysqlConnectionPool {
     ...
     */
    public MysqlConnectionPool(String jdbcDriver, String dbUrl, String dbUsername,
                               String dbPassword) {
